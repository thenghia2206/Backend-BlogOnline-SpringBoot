...
public class CommentService {
    ...
    public void createComment(CommentDto commentDto) {
        ...
        PostDtoOutput postDto = postService.readSinglePost(commentDto.getPost_id());
        postService.updateNumComment(commentDto.getPost_id(), postDto, 1L);
    }
    @Transactional
    ...
    public void deleteComment(Long id) {
        Comment comment = commentRepository.findById(id).orElseThrow(() -> new PostNotFoundException("For id " + id));
        CommentDto commentDto =  mapFromCommentToDto(comment);
